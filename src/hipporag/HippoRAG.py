...
class HippoRAG:
    ...
    def index(self, docs: List[str]):
        ...
        if self.global_config.graph_use_canonical_triples:
            ner_results_dict, triple_results_dict = reformat_openie_results_for_canonical_graph(
                all_openie_info,
                drop_self_loop_triples=self.global_config.graph_drop_self_loop_triples,
            )
        else:
