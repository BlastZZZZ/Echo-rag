...
def prefix_queries_with_instruction(texts: List[str], instruction: str) -> List[str]:
...
class EmbeddingCache:
    ...
    def _ensure_cache(cls):
        ...
        with cls._lock:
            ...
            try:
                ...
                logger.warning(
                    "Falling back to an in-process embedding cache because multiprocessing.Manager() is unavailable: %s",
                    exc,
                )
                cls._manager = None
                cls._cache = {}
    ...
    def get(cls, content):
        ...
        return cls._ensure_cache().get(content)
    ...
    def contains(cls, content):
        ...
        return content in cls._ensure_cache()
